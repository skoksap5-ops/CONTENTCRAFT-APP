...
export default function Login() {
  ...
  return (
    <>
      <Head><title>Prijava - ContentCraft</title></Head>
      <div style={{ maxWidth: '400px', margin: '100px auto', padding: '40px', border: '1px solid #ddd', borderRadius: '10px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
        <h2 style={{ textAlign: 'center', marginBottom: '30px' }}>Prijavi se</h2>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <button onClick={() => handleOAuthLogin('google')} disabled={loading} style={{ width: '100%', padding: '12px', background: '#fff', border: '1px solid #ddd', borderRadius: '5px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', cursor: 'pointer' }}>
            <img src="https://developers.google.com/identity/images/g-logo.png" alt="Google" width="20" height="20" />
            Google
          </button>
          <button onClick={() => handleOAuthLogin('github')} disabled={loading} style={{ width: '100%', padding: '12px', background: '#333', color: 'white', border: '1px solid #333', borderRadius: '5px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', cursor: 'pointer' }}>
        ...
        <p style={{ textAlign: 'center', marginTop: '20px' }}>
          Nemaš nalog? <a href="/signup" style={{ color: '#007acc' }}>Registruj se</a>
        </p>
      </div>
    </>
  );
